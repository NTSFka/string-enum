...
TEST_CASE("string_enum to_string", "[unit]")
{
    struct data
    {
        test_enum1 input;
...
TEST_CASE("string_enum to_string invalid", "[unit]")
{
...
TEST_CASE("string_enum try_from_string", "[unit]")
{
    struct data
    {
...
TEST_CASE("string_enum from_string", "[unit]")
{
    struct data
    {
        std::string_view input;
...
TEST_CASE("string_enum from_string invalid", "[unit]")
{
